(function() {
    ...
    $.Autocompleter = function(input, options) {
        ...
        $input.keydown(function(event) {
            ...
            case KEY.RETURN:
                if (selectCurrent()) {
                    if (!options.multiple) $input.blur();
                    event.preventDefault();
                }
                break;
            case KEY.ESC:
...
function curvyObject() {
    ...
    if (this.settings.autoPad == true && (this.boxPaddingTop > 0 || this.boxPaddingBottom > 0 || this.boxPaddingLeft > 0 || this.boxPaddingRight > 0)) this.box.innerHTML = "";
    this.applyCorners = function() {
            ...
            case 0:
                if (this.settings.tl || this.settings.tr) {
                    ...
                    $(newMainContainer).css({
                        ...
                        overflow: "hidden",
                        position: "absolute",
                        "padding-left": this.borderWidth,
                        "padding-right": this.borderWidth,
        ...
        if (this.settings.autoPad == true && (this.boxPaddingTop > 0 || this.boxPaddingBottom > 0 || this.boxPaddingLeft > 0 || this.boxPaddingRight > 0)) {
            ...
            if (topMaxRadius < this.boxPaddingTop) $(contentContainer).css("padding-top", topPadding);
            else $(contentContainer).css("padding-top", this.boxPaddingTop);
            if (botMaxRadius < this.boxPaddingBottom) $(contentContainer).css("padding-bottom", botPadding);
            else $(contentContainer).css("padding-bottom", this.boxPaddingBottom);
            $(contentContainer).css({
                "padding-left": this.boxPaddingLeft,
                "padding-right": this.boxPaddingRight
            });
            ...
            if (i > -1 < 4) {
                ...
                if (!this.settings[cc]) {
                    if (((cc == "tr" || cc == "tl") && this.topContainer != null) || ((cc == "br" || cc == "bl") && this.bottomContainer != null)) {
                        ...
                        if (this.bgImage == "") $(newCorner).css("background-color", this.boxColour);
                        else $(newCorner).css("background-image", this.bgImage).css("background-color", this.boxColour);;
                        switch (cc) {
                        case "tl":
                            $(newCorner).css({
                                height:
                                ...
                                "background-position": this.borderWidth + "px 0px"
                            });
                            break;
                        case "tr":
                            $(newCorner).css({
                            ...
                            break;
                        case "bl":
                            if (topMaxRadius > 0) $(newCorner).css({
                                ...
                                left: -this.borderWidth + "px",
                                "background-repeat": $(this.box).css("background-repeat"),
                                "background-position": "0px -" + ($(this.box).height() + topMaxRadius - this.borderWidth + 1) + "px"
                            });
                            else $(newCorner).css({
                                height: botMaxRadius - this.borderWidth,
                                "margin-right": this.settings.br.radius - (this.borderWidth * 2),
                                ...
                                left: -this.borderWidth + "px",
                                "background-repeat": $(this.box).css("background-repeat"),
                                "background-position": "0px -" + ($(this.box).height()) + "px"
                            });
                            break;
                        case "br":
                            if (topMaxRadius > 0) $(newCorner).css({
                                ...
                                left: this.borderWidth + "px",
                                "background-repeat": $(this.box).css("background-repeat"),
                                "background-position": "-" + this.settings.bl.radius + this.borderWidth + "px -" + ($(this.box).height() + topMaxRadius - this.borderWidth + 1) + "px"
                            });
                            else $(newCorner).css({
                                height: botMaxRadius - this.borderWidth,
                                "margin-left": this.settings.bl.radius - (this.borderWidth * 2),
                                ...
                                left: this.borderWidth + "px",
                                "background-repeat": $(this.box).css("background-repeat"),
                                "background-position": "-" + this.settings.bl.radius + this.borderWidth + "px -" + ($(this.box).height()) + "px"
                            });
                            break;
                        };
                    };
                    ...
                    if (cc != "br") {
                        for (var t = 0, k = newCorner.childNodes.length; t < k; t++) {
                            ...
                            case "tl":
                                ...
                                break;
                            case "bl":
                                if (topMaxRadius > 0) $(pixelBar).css("background-position", "-" + Math.abs((this.settings[cc].radius - pixelBarLeft - 1) - this.borderWidth) + "px -" + Math.abs(($(this.box).height() + topMaxRadius - this.borderWidth + 1)) + "px");
                                else $(pixelBar).css("background-position", "-" + Math.abs((this.settings[cc].radius - pixelBarLeft - 1) - this.borderWidth) + "px -" + Math.abs(($(this.box).height())) + "px");
                                break;
                            };
                        };
                    };
            ...
            if (z == "t" || z == "b") {
                if (radiusDiff[z]) {
                    ...
                    $(newFiller).css({
                        ...
                        "font-size": "1px",
                        overflow: "hidden",
                        "background-color": this.boxColour
                    });
                ...
                case "t":
                    if (this.topContainer) {
                        if (this.settings.tl.radius && this.settings.tr.radius) {
                            ...
                            if (this.bgImage != "") $(newFillerBar).css("background-position", "-" + (topMaxRadius + this.borderWidth) + "px 0px");
                ...
                case "b":
                    if (this.bottomContainer) {
                        if (this.settings.bl.radius && this.settings.br.radius) {
                            ...
                            if (this.bgImage != "" && topMaxRadius > 0) $(newFillerBar).css("background-position", "-" + (this.settings.bl.radius - this.borderWidth) + "px -" + ($(this.box).height() + topMaxRadius - this.borderWidth + 1) + "px");
                            else $(newFillerBar).css("background-position", "-" + (this.settings.bl.radius - this.borderWidth) + "px -" + ($(this.box).height()) + "px");
    ...
    this.drawPixel = function(intx, inty, colour, transAmount, height, newCorner, image, cornerRadius) {
        ...
        if (image == -1 && this.bgImage != "") {
            if (topMaxRadius > 0) $(pixel).css("background-position", "-" + ((this.boxWidth - cornerRadius - this.borderWidth) + intx) + "px -" + (($(this.box).height() + topMaxRadius - this.borderWidth) - inty) + "px");
            else $(pixel).css("background-position", "-" + ((this.boxWidth - cornerRadius - this.borderWidth) + intx) + "px -" + (($(this.box).height()) - inty) + "px");
            $(pixel).css({
                "background-image": this.bgImage,
                "background-repeat": $(this.box).css("background-repeat"),
...
function strip_px(value) {
    ...
    $.facebox = function(data, klass) {
        $.facebox.loading() if (data.ajax) fillFaceboxFromAjax(data.ajax)
    ...
    <div id="facebox" style="display:none;"> \
      <div class="popup"> \
        ...
        loading: function() {
            init() if ($('#facebox .loading').length == 1) return true showOverlay() $('#facebox .content').empty() $('#facebox .body').children().hide().end().append('<div class="loading"><img src="' + $.facebox.settings.loadingImage + '"/></div>') $('#facebox').css({
                top: getPageScroll()[1] + (getPageHeight() / 10),
                left: 385.5
            }).show() $(document).bind('keydown.facebox',
            function(e) {
                if (e.keyCode == 27) $.facebox.close() return true
            }) $(document).trigger('loading.facebox')
        },
        reveal: function(data, klass) {
            $(document).trigger('beforeReveal.facebox') if (klass) $('#facebox .content').addClass(klass) $('#facebox .content').append(data) $('#facebox .loading').remove() $('#facebox .body').children().fadeIn('normal') $('#facebox').css('left', $(window).width() / 2 - ($('#facebox table').width() / 2)) $(document).trigger('reveal.facebox').trigger('afterReveal.facebox')
        },
        close: function() {
            $(document).trigger('close.facebox') return false
        }
    }) $.fn.facebox = function(settings) {
        init(settings) function clickHandler() {
            $.facebox.loading(true) var klass = this.rel.match(/facebox\[?\.(\w+)\]?/) if (klass) klass = klass[1] fillFaceboxFromHref(this.href, klass) return false
        }
        return this.click(clickHandler)
    }
    function init(settings) {
        if ($.facebox.settings.inited) return true
        else $.facebox.settings.inited = true $(document).trigger('init.facebox') makeCompatible() var imageTypes = $.facebox.settings.imageTypes.join('|') $.facebox.settings.imageTypesRegexp = new RegExp('\.' + imageTypes + '$', 'i') if (settings) $.extend($.facebox.settings, settings) $('body').append($.facebox.settings.faceboxHtml) var preload = [new Image(), new Image()] preload[0].src = $.facebox.settings.closeImage preload[1].src = $.facebox.settings.loadingImage $('#facebox').find('.b:first, .bl, .br, .tl, .tr').each(function() {
    ...
    function makeCompatible() {
        var $s = $.facebox.settings $s.loadingImage = $s.loading_image || $s.loadingImage $s.closeImage = $s.close_image || $s.closeImage $s.imageTypes = $s.image_types || $s.imageTypes $s.faceboxHtml = $s.facebox_html || $s.faceboxHtml
    }
    function fillFaceboxFromHref(href, klass) {
        if (href.match(/#/)) {
            var url = window.location.href.split('#')[0] var target = href.replace(url, '') $.facebox.reveal($(target).clone().show(), klass)
    ...
    function showOverlay() {
        if (skipOverlay()) return if ($('facebox_overlay').length == 0) $("body").append('<div id="facebox_overlay" class="facebox_hide"></div>') $('#facebox_overlay').hide().addClass("facebox_overlayBG").css('opacity', $.facebox.settings.opacity).click(function() {
            $(document).trigger('close.facebox')
        }).fadeIn(200) return false
    }
    function hideOverlay() {
        if (skipOverlay()) return $('#facebox_overlay').fadeOut(200,
        function() {
            $("#facebox_overlay").removeClass("facebox_overlayBG") $("#facebox_overlay").addClass("facebox_hide") $("#facebox_overlay").remove()
        }) return false
    }
    $(document).bind('close.facebox',
    function() {
        $(document).unbind('keydown.facebox') $('#facebox').fadeOut(function() {
            $('#facebox .content').removeClass().addClass('content') hideOverlay() $('#facebox .loading').remove()
        })
    })
})(jQuery); (function($) {
    ...
    $.hotkeys = function(options) {
        for (key in options) $.hotkey(key, options[key]) return this
    }
    ...
    }) $(document).bind('keydown.hotkey',
    function(e) {
        if ($(e.target).is(':input')) return if (e.shiftKey || e.ctrlKey || e.altKey || e.metaKey) return true
        var el = $.hotkeys.cache[e.keyCode] if (el) $.isFunction(el) ? el.call(this) : window.location = el
    })
}); (function($) {
    ...
    $r = $.relatizeDate $.extend($.relatizeDate, {
        ...
        strftime: function(date, format) {
            ...
            return format.replace(/\%([aAbBcdHImMpSwyY])/g,
            function(part) {
                switch (part[1]) {
                case 'a':
    ...
    $.fn.spamjax = function(callback, settings) {
        ...
        var options = {}
        if (!$.facebox) settings.facebox = null options.complete = function(xhr, ok) {
            callback.call(this, xhr.responseText, ok)
        }
        if (settings.confirmation) {
            options.beforeSubmit = function() {
                var execute = confirm(settings.confirmation) if (!execute) return false
            ...
            $this.html(["<div class='truncate_less'>", $this.html(), settings.trail[0], "</div>"].join("")).find(".truncate_show", this).click(function() {
                if ($this.find(".truncate_more").length == 0) {
                    $this.append(["<div class='truncate_more' style='display: none;'>", myResults[myResultsKey], settings.trail[1], "</div>"].join("")).find(".truncate_hide").click(function() {
                        $this.find(".truncate_more").css("background", "#fff").fadeOut("normal",
                        function() {
                            $this.find(".truncate_less").css("background", "#fff").fadeIn("normal",
                            function() {
                                fixIE(this);
                ...
                $this.find(".truncate_less").fadeOut("normal",
                function() {
                    $this.find(".truncate_more").fadeIn("normal",
                    function() {
                        fixIE(this);
                    });
                    fixIE(this);
                ...
                jQuery(".truncate_show", $this).click(function() {
                    $this.find(".truncate_less").css("background", "#fff").fadeOut("normal",
                    function() {
                        $this.find(".truncate_more").css("background", "#fff").fadeIn("normal",
                        function() {
                            fixIE(this);
                            $(this).css("background", "none");
                        });
...
$.fn.scrollTo = function(el, speed) {
    if (typeof el == 'number' || !el) {
        speed = el target = this container = 'html,body'
    } else {
        target = el container = this
    }
    var offset = $(target).offset().top - 30 $(container).animate({
        scrollTop: offset
    },
    speed || 1000) return this
}
$.gitbox = function(url, klass) {
    $.facebox(function() {
        $.get(url,
        function(data) {
            $.facebox(data, 'nopad') $('#facebox .footer').hide()
        })
    })
}
$.fn.spin = function() {
...
$.extend(GitHub, {
    positionTriangle: function() {
        if ($('#triangle').length == 0) $('body').append('<div id="triangle" style="position: absolute; display: none;"> </div>') var d = $('#repo_menu .active')[0] if (d) {
            var tarray = $('#triangle').show() var t = tarray[0];
            var offset = $(d).offset() var height = $(d).outerHeight() t.style.top = '' + (offset.top + height) + 'px';
            t.style.left = '' + offset.left + 'px';
            if ($('#repo_menu .site').length > 0) var ref = $('#repo_menu .site')[0].offsetLeft;
            if ($('#repo_sub_menu .site a').length > 0) $('#repo_sub_menu .site a')[0].style.marginLeft = (((d.offsetLeft - ref) / 13.34) - 1) + 'em';
        }
    },
    scrollToHilightedLine: function() {
        var lines,
        target = window.location.hash
        if (lines = target.match(/^#?(?:L|-)(\d+)$/g)) {
            lines = $.map(lines,
            function(line) {
    ...
    GitHub.positionTriangle() GitHub.scrollToHilightedLine() $('.jshide').hide() $('.toggle_link').click(function() {
        $($(this).attr('href')).toggle() return false
    }) $('#beta :text').focus(function() {
        if ($(this).val() == 'your email') $(this).val('')
    }) if ($.fn.ajaxForm) {
        $('#beta form').ajaxForm(function() {
            $('#beta form').hide() $('#beta .thanks').show()
        })
    }
    $('.hide_alert').click(function() {
        $('#site_alert').slideUp() $.cookie('hide_alert', 't', {
            expires: 7
        }) return false
    }) if ($.cookie('hide_alert')) $('#site_alert').hide() $('#login_field').focus() $('#versions_select').change(function() {
        location.href = this.value
    }) if ($.facebox) $('a[rel*=facebox]').facebox() if ($.fn.truncate) {
    ...
    if ($.fn.corner) $('.corner').corner() $.user_autocomplete = function() {
        if (!$.fn.autocomplete) return $(".autocompleter").autocomplete('/users/ajax_search') $(".autocompleter").result(function() {
            $(this).css('background', '#73DFFF')
...
$.ajaxSetup({
...
}) GitHub.highlightLines = function(e) {
    var target,
    lines
    if (e) {
        $('.line').css('background-color', 'transparent') target = $(this).attr('rel') if (e.shiftKey) {
            target = window.location.hash.replace(/-\d+/, '') + '-' + target.replace(/\D/g, '')
        }
    ...
    if (lines = target.match(/#?(?:L|-)(\d+)/g)) {
        ...
        function(line) {
            return parseInt(line.replace(/\D/g, ''))
        }) if (lines.length == 1) return $('#LC' + lines[0]).css('background-color', '#ffc') for (var i = lines[0]; i <= lines[1]; i++) $('#LC' + i).css('background-color', '#ffc') $('#LC' + lines[0]).scrollTo(1)
    }
    return false
}
$(function() {
    GitHub.highlightLines() $('.line_numbers span').mousedown(GitHub.highlightLines)
});
GitHub.Commit = {
    currentBubble: null,
    ...
    addEmptyClass: function() {
        if (!$(this).data('clicked') && $(this).text() == '0') $(this).addClass('empty')
    },
    highlightLine: function() {
        $(this).parent().css('background', '#ffc')
    },
    unhighlightLine: function() {
        if (!$(this).data('clicked')) $(this).parent().css('background', '')
    },
    jumpToHashFile: function() {
        if (window.location.hash && !/diff-\d+/.test(window.location.hash)) {
            var line,
            hash = window.location.hash
            if (position = hash.match(/-P(\d+)/)) {
                hash = hash.replace(position[0], '') position = position[1]
            }
            var target = $('#toc a:contains("' + hash.replace('#', '') + '")') if (target.length > 0) {
                var diff = target.attr('href') $(diff).scrollTo(1) if (position) {
                    setTimeout(function() {
                        GitHub.Commit.highlightLine.call($(diff + ' .cp-' + position))
                    },
                    50)
                }
            }
    ...
    observeHash: function() {
        if (window.location.hash != GitHub.Commit.oldHash) {
            GitHub.Commit.oldHash = window.location.hash GitHub.Commit.jumpToHashFile()
        }
    }
}
$(function() {
    GitHub.Commit.jumpToHashFile() GitHub.Commit.oldHash = window.location.hash setInterval(GitHub.Commit.observeHash, 50) $('.bubble.empty').hover(GitHub.Commit.dumpEmptyClass, GitHub.Commit.addEmptyClass) $('.bubble').hover(GitHub.Commit.highlightLine, GitHub.Commit.unhighlightLine) $(document).bind('close.facebox',
    function() {
        if (GitHub.currentBubble) {
            var el = GitHub.currentBubble $(el).data('clicked', false) GitHub.Commit.unhighlightLine.call(el) GitHub.Commit.addEmptyClass.call(el)
        }
    }) $('.bubble').click(function() {
        $(this).data('clicked', true) GitHub.currentBubble = $(this) var url = window.location.pathname.replace('commit', 'comments') url += '/' + $.trim($(this).parents('.file').find('.meta').text()) var pos = parseInt($(this).attr('class').match(/cp-(\d+)/)[1]) url += '?position=' + pos
        if (pos) {
            var firstLine = parseInt($(this).parents('tbody').find('.line_numbers:first > a:first').text()) url += '&line=' + (firstLine + pos - 1)
        }
        $.gitbox(url)
    }) $('.add_comment').livequery('click',
    function() {
        var text = $.trim($('#commit_comment_form textarea').val()) if (text == '') {
            $('#commit_comments .inner').scrollTo('#commit_comment_form')
        } else {
            $('.add_comment').attr('disabled', true).spin() $.post($('#commit_comment_form').attr('action'), {
                body: text
            },
            function(data) {
                $('.no_one').remove() $('.comment_list').append('<li>' + data + '</li>') $('#commit_comment_form textarea').val('') $('.add_comment').attr('disabled', false).stopSpin() var count = GitHub.currentBubble.find('span') count.text(parseInt(count.text()) + 1)
            })
        }
    }) $.each(['line', 'file', 'all'],
    function(_, type) {
        var klass = type + '_link'$('a.' + klass).livequery('click',
        function() {
            $('.links a').show() $('h1 span').hide() $('span.' + klass).show() $('a.' + klass).hide() $('span.' + type + '_header').show() $('.comment_list').hide() $('#comments_for_' + type).toggle() return false
        })
    })
});
GitHub.Commits = {
    ...
    select: function(index) {
        this.current = index $('.selected').removeClass('selected') return this.elements.eq(index).addClass('selected')
    },
    next: function() {
        if (this.current !== null) {
            if (this.elements.length - 1 == this.current) return var el = this.select(++this.current) if (el.offset().top - $(window).scrollTop() + 50 > $(window).height()) el.scrollTo(200)
        } else {
            this.select(0)
        }
    },
    prev: function() {
        if (!this.current) {
            this.elements.eq(0).removeClass('selected') return this.current = null
        }
        var el = this.select(--this.current) if (el.offset().top - $(window).scrollTop() < 0) el.scrollTo(200)
    },
    link: function(key) {
        if (GitHub.Commits.current === null) return false window.location = GitHub.Commits.selected().find('[hotkey=' + key + ']').attr('href')
    }
}
$(function() {
    GitHub.Commits.elements = $('.commit') $.hotkeys({
        c: function() {
...
$(function() {
    $('#invite_to_beta').focus(function() {
        $(this).val('')
    }) $('#beta_invite_form').spamjax(function(text, status) {
        var inside = '#invite_' + status
        var email = $('#invite_to_beta').val() $.facebox($(inside).text() + email) if (status == 'success') {
            var left = $('#invites_remaining').text() $('#invites_remaining').text(parseInt(left) - 1) $('#invite_to_beta').val('') $('#invited_emails').append('<li>' + email + '</li>')
        }
    },
    {
        facebox: true
    }) $('.repo_filter').click(function() {
        $('#repo_listing li').hide() $('#repo_filter a').removeClass('filter_selected') $(this).addClass('filter_selected') $('#repo_listing li.' + $(this).attr('rel')).show() return false
    }) $('.betas h1').css('cursor', 'pointer').click(function() {
        $('#invited_emails').toggle()
    })
});
GitHub.editableGenerator = function(options) {
    return function(_, self) {
        var defaults = {
            ...
            onblur: function() {
                var reset = function() {
                    $(self).trigger('reset').next().show()
                }
                $.data(self, 'timeout', reset.delay(20))
            },
            callback: function() { (function() {
                    if ($(self).attr('data')) $(self).attr('data', $(self).text()) $(self).trigger('truncate').next().show()
                }).delay(20)
            }
        }
...
$(function() {
    $('.edit_link').click(function() {
        $(this).prev().trigger('click') return false
    })
});
$(function() {
    $('.repo span.edit').each(GitHub.editableGenerator({
        ...
        $('#add_new_member').show() $('#add_member').focus() return false
    }) $('#add_member_cancel').click(function() {
        $('#add_new_member').hide().find('input[type=text]').val('') return false
    }) $('#add_new_member form').submit(function() {
        $('#add_member_cancel').spin() $('#add_new_member :submit').attr('disabled', true) $.post(this.action, {
            'member': $('#add_member').val()
        },
        function(data) {
            if ($.inArray($(data).find('a:first').text(), $('.members li a:not(.action)').map(function() {
                return $(this).text()
            })) == -1) $('.members').append(data) $('#add_member').val('').css('background-color', '').focus() $('#add_new_member :submit').attr('disabled', false) $('#spinner').remove()
        }) return false
        ...
        $('.public_repo, .private_repo, .public_security, .private_security').toggle() if ($('.repo').is('.public')) $('.repo').removeClass('public').addClass('private')
        else $('.repo').removeClass('private').addClass('public') $.post(this.href, '') return false
    }) $('#copy_permissions ul li a').click(function() {
        $(this).parents('form').submit() return false
    }) $('#delete_repo').click(function() {
        var confirm_string = 'Are you sure you want to delete this repository?  There is no going back.'
        if (!confirm(confirm_string)) return false
    }) $('.toggle_watch').click(function() {
        if ($('.userbox').length == 0) return true $('.toggle_watch').toggle() $.post($(this).attr('href'), {
            data: {}
        }) return false
    }) $('.git_url_facebox').click(function() {
        $.facebox($($(this).attr('rel')).html(), 'tip') return false
    }) $('#donate_activate_toggle a').click(function() {
        $(this).parent().hide() $('#donate_activate').show() return false
    }) $('#pledgie_deactivate').click(function() {
        $('#paypal').val('') return true
    }) $('.pull_request_button').click(function() {
        var self = this $.facebox(function() {
            $.get(self.href,
            function(data) {
                $.facebox(data, 'nopad') $('#facebox .footer').hide() $.user_autocomplete()
            })
        }) return false
    }) $('.repo_toggle').click(function() {
        var options = {}
        options['field'] = this.id options['value'] = this.checked ? '1': '0'
        var url = window.location.pathname.replace('edit', 'update') $.post(url, options) $('#rubygem_save').show()
    }) $('.hook_help').click(function() {
        var div = $('#' + this.id.replace('-toggle', '')) if (div.is(":visible")) {
            div.hide()
        } else {
            div.show() div.html('<pre>Loading...</pre>') var url = '/pjhyett/github-services/tree/master/docs/' + div.attr('id').replace('-help', '') $.get(url, {
                'raw': 'true'
            },
            function(data) {
        ...
        return false
    }) $('#close_facebox').livequery('click',
    function() {
        $(document).trigger('close.facebox') return false
    }) $('#pull_request .select_all').livequery('click',
    function() {
        $('#facebox :checkbox').attr('checked', true) return false
    }) $('#pull_request .add_recipient').livequery('click',
    function() {
        var user = $(this).prev().val() $(this).prev().val('').css('background', 'Window') if (!$.trim(user)) return var list = $('#pull_request .recipients ul') var recipients = list.find('li').map(function() {
            return $.trim($(this).text())
        }) if ($.inArray(user, recipients) >= 0) return list.find('li:contains(' + user + ') :checkbox').attr('checked', true) $('#pull_request .recipients ul').prepend('<li><label><input type="checkbox" name="message[to][]" value="' + user + '"/> ' + user + '</label>').end().find(':checkbox:first').attr('checked', true)
    }) $('#pull_request_form').livequery('submit',
    function() {
        var empty = [] var recipient_controls = $(this).find("input[name='message[to][]']") recipient_controls.each(function() {
            if ($(this).is(':checkbox') && !$(this).attr('checked') || $(this).is(':text') && $(this).val() == '') empty.push($(this))
        }) if (empty.length == recipient_controls.length) {
            $('#pull_request_error').show().text('Please select at least one recipient.') return false
        } else {
            $(this).ajaxSubmit(function() {
                $('#pull_request_error').remove() $('#pull_request').find('h1').text('Sent!').end().find('.pull_request_inside').empty().append('<p>Your pull request was sent.</p>').end().find('.actions :last').remove().end().find('#close_facebox').val('Close') var close = setTimeout(function() {
                    $(document).trigger('close.facebox')
                },
                2500) $(document).one('close.facebox',
                function() {
                    clearTimeout(close)
                })
            }) return false
...
GitHub.Fluid = {
    init: function() {
        if (!window.fluid) return with(GitHub.Fluid) {
            setDockCount() addMenuItems()
        }
    },
    setDockCount: function() {
        window.fluid.dockBadge = $('.inbox strong a').text()
    },
    addMenuItems: function() {
        with(GitHub.Fluid) {
            addDockJump("My Account", '/account') addDockJump("News", '/news') addDockJump("Repositories", '/repositories') addDockJump("Popular Watched", '/popular/watched') addDockJump("Popular Forked", '/popular/forked')
        }
    },
    addDockJump: function(name, path) {
        window.fluid.addDockMenuItem(name,
        function() {
...
$(GitHub.Fluid.init);
$(function() {
    $('#header .inbox, .cancel').click(function() {
        ...
        $(this).parent().hide() $('.hidden_message').show() return false
    })
});
$(function() {
    $('#add_key').click(function() {
        $('#public_keys textarea:last').after($('#public_keys textarea:first').clone().html('')) return false
    }) $('#remove_key').click(function() {
        if ($('#public_keys textarea').length == 1) {
            $('#public_keys textarea').val('')
        } else {
            $('#public_keys textarea:last').val('').remove()
        }
        return false
    }) $('#remove_key').mouseover(function() {
        $('#public_keys textarea:last').css('background', '#ffc')
    }) $('#remove_key').mouseout(function() {
        $('#public_keys textarea:last').css('background', '#fff')
    })
});
$(function() {
    $('#signup_form').keydown(function(e) {
        if ($(this).find(':submit').attr('disabled') && e.keyCode == 13) return false
    }) $('#signup-terms').click(function() {
        $('#signup-button').attr('disabled', !this.checked)
    }) $('#signup-button').click(function() {
        $(this).attr('disabled', true) $(this).val('Creating your GitHub account...') $('#signup_form').submit()
    })
});
$(function() {
...
$(function() {
    $('a.follow').click(function() {
        $.post(this.href, '') $(this).parent().find('.follow').toggle() return false
    }) if (GitHub.editableGenerator) $('#dashboard span.edit').each(GitHub.editableGenerator({
        width: '200px',
        submittype: 'put'
    })) $('.user_toggle').click(function() {
        var options = {}
        options[this.name] = this.checked ? '1': '0'options['_method'] = 'put'$.post('/account', options) $('#notify_save').show()
    }) $('#add_email_action').click(function() {
        $(this).toggle() $('#add_email_form').toggle().find(':text').focus() return false
    }) $('#cancel_add_email').click(function() {
        $('#add_email_action').toggle() $('#add_email_form').toggle().find(':text').val('') return false
    }) $('.delete_email').livequery('click',
    function() {
        if ($('.email').length == 1) {
            $.facebox('You must always have at least one email address.  If you want to delete this address, add a new one first.') return false
        }
        $.post($(this).attr('href'), {
            email: $(this).prev().text()
        }) $(this).parent().remove() return false
    }) if ($('.email').length > 0) {
        $('#add_email_form').submit(function() {
            $('#add_email_form :submit').attr('disabled', true).spin() var self = this $(this).ajaxSubmit(function(user) {
                $('.emails ul').append(user) $('#add_email_form :submit').attr('disabled', false).stopSpin() $(self).find(':text').val('').focus()
            }) return false
        })
    }
    $('#change_plan_toggle').click(function() {
        $('.plan_box').hide() $('#change_plan').show() return false
    }) $('#update_cc_toggle').click(function() {
        $('.plan_box').hide() $('#update_cc').show() return false
    }) $('.plan_cancel').click(function() {
        $('.plan_box').hide() $('#current_plan').show() return false
    }) $('#change_plan_form').submit(function() {
        var plan = $('#plan_selector').val() $('#update_cc_form input#plan').val(plan) if (plan == 'free') {
            $('#update_cc_form').submit() return false
        }
        $('strong.plan_pricing').hide() $('#change_plan').hide() if (plan == 'coupon') {
            $('#coupon_box').show() return false
        }
        $('#' + plan + '_cost').show() $('#update_cc').show() if (!$('#can_update_cc').is('.dont_show')) $('#can_update_cc').show() return false
    }) $('#plan_update_button').click(function() {
        $('#update_cc_form').submit() return false
    }) $('#update_cc_form input[type=submit]').click(function() {
        $(this).attr('disabled', true) $(this).val('Processing Credit Card...') $('#update_cc_form').submit()
    })
});
$(function() {
    var swap_search_and_links = function() {
        $('#header .userbox .site_links').toggle() $('#header .userbox form').toggle() $(this).is(':visible') setTimeout(function() {
            $('#header :text').focus()
        },
        50) return false
    }
    $('#header .userbox .search_repos_link').livequery('click', swap_search_and_links) $('#header .userbox .cancel_search_link').livequery('click', swap_search_and_links) $.hotkey('s',
    function() {
